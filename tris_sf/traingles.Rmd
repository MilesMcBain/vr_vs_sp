...
# Choosing the right z is important: https://mapzen.com/documentation/terrain-tiles/data-sources/#what-is-the-ground-resolution
nc_raster <- elevatr::get_elev_raster(as(nc, 'Spatial'), z = 10, src = "aws")
```