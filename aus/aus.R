...
p_mesh <- anglr(states, max_area = 0.008) ## make small triangles ( sq lon-lat degree)
...
output <- sprintf(
  ...
  "materials": [ {"DbgColor": 15597568,
                ...
                "colorAmbient": [0, 0, 0],
                "colorDiffuse": [0.60000000, 0.27843137, 0.09411765],
                "colorEmissive": [0.0, 0.0, 0.0],
                "colorSpecular": [0.60000000, 0.27843137, 0.09411765],
                "depthTest": true,
                "depthWrite": true,
                "shading": "Phong",
                "specularCoef": 0.0,
